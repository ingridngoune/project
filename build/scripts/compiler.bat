...
set CLASSPATH=%APP_HOME%\lib\compiler.jar;%APP_HOME%\lib\junit-4.13.2.jar;%APP_HOME%\lib\asm-9.6.jar;%APP_HOME%\lib\guava-31.1-jre.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.12.0.jar;%APP_HOME%\lib\error_prone_annotations-2.11.0.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar


@rem Execute compiler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COMPILER_OPTS%  -classpath "%CLASSPATH%" compiler.Compiler %*
